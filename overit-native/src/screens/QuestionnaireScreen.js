...
const styles = StyleSheet.create({
  ...
  chip:            { paddingVertical: 10, paddingHorizontal: 16, borderRadius: 50, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', backgroundColor: 'rgba(22,18,42,0.5)', flexShrink: 0 },
  chipSel:         { borderColor: 'rgba(124,58,237,0.6)', backgroundColor: 'rgba(124,58,237,0.17)' },
  chipDisabled:    { opacity: 0.35 },
  chipText:        { fontSize: 13.5, color: t.textDim, flexShrink: 0 },
