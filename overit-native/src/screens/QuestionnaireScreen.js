...
const styles = StyleSheet.create({
  ...
  navBtn:      { width: 60 },
  navBtnText:  { fontSize: 13, color: t.mutedLt , includeFontPadding: false},
  stepCount:   { fontSize: 11, color: t.muted , includeFontPadding: false},
  scroll:        { flex: 1 },
  ...
  subtitle: { fontSize: 13, color: t.mutedLt, marginBottom: 20 , includeFontPadding: false},
  textInput: {
  ...
  cardText:        { fontSize: 14, color: t.textDim, flex: 1 , includeFontPadding: false},
  ...
  maxHint: { fontSize: 11, color: t.muted, marginTop: 12, textAlign: 'center' , includeFontPadding: false},
