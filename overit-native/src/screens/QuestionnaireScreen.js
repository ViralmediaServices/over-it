...
const styles = StyleSheet.create({
  ...
  navBtn:      { width: 60 },
  navBtnText:  { fontSize: 13, color: t.mutedLt , includeFontPadding: false, fontWeight: '400'},
  stepCount:   { fontSize: 11, color: t.muted , includeFontPadding: false, fontWeight: '400'},
  scroll:        { flex: 1 },
  scrollContent: { padding: 24, paddingTop: 12, maxWidth: 480, width: '100%', alignSelf: 'center' },
  eyebrow:  { fontSize: 11, color: '#7c3aed', letterSpacing: 0.8, textTransform: 'uppercase', marginBottom: 10, fontWeight: '600' , includeFontPadding: false},
  question: { fontSize: 22, fontWeight: '700', letterSpacing: -0.4, lineHeight: 29, color: t.text, marginBottom: 6 , includeFontPadding: false},
  subtitle: { fontSize: 13, color: t.mutedLt, marginBottom: 20 , includeFontPadding: false, fontWeight: '400'},
  textInput: {
  ...
  check:       { color: '#fff', fontSize: 9, fontWeight: '700' , includeFontPadding: false},
  cardText:        { fontSize: 14, color: t.textDim, flex: 1 , includeFontPadding: false, fontWeight: '400'},
  cardTextSel:     { fontSize: 14, color: '#c4b5fd', fontWeight: '600' , includeFontPadding: false},
  ...
  chipText:        { fontSize: 13, color: t.textDim, includeFontPadding: false , fontWeight: '400'},
  chipTextSel:     { color: '#c4b5fd', fontWeight: '600' },
  chipTextDisabled:{ color: t.muted },
  maxHint: { fontSize: 11, color: t.muted, marginTop: 12, textAlign: 'center' , includeFontPadding: false, fontWeight: '400'},
  ...
  btnText: { color: '#fff', fontSize: 15, fontWeight: '600', letterSpacing: -0.2 , includeFontPadding: false},
});
