...
const styles = StyleSheet.create({
  ...
  sub:          { fontSize: 13.5, color: t.mutedLt, lineHeight: 21, textAlign: 'center' , includeFontPadding: false, fontWeight: '400'},
  ...
  ghostBtnText: { color: t.textDim, fontSize: 14 , includeFontPadding: false, fontWeight: '400'},
  divider:      { flexDirection: 'row', alignItems: 'center', width: '100%', marginVertical: 20, gap: 12 },
  dividerLine:  { flex: 1, height: 1, backgroundColor: 'rgba(255,255,255,0.06)' },
  dividerText:  { fontSize: 11, color: t.muted , includeFontPadding: false, fontWeight: '400'},
  ...
  input:        { backgroundColor: 'rgba(30,26,53,0.6)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', borderRadius: 10, padding: 13, color: t.text, fontSize: 14 , includeFontPadding: false, fontWeight: '400'},
  inputFocused: { borderColor: 'rgba(124,58,237,0.55)' },
  error:        { color: '#f87171', fontSize: 12.5, marginBottom: 12, textAlign: 'center', width: '100%' , includeFontPadding: false, fontWeight: '400'},
  ...
  toggle:       { marginTop: 16 },
  toggleText:   { color: t.mutedLt, fontSize: 13 , includeFontPadding: false, fontWeight: '400'},
  legal:        { fontSize: 11, color: t.muted, textAlign: 'center', marginTop: 22, lineHeight: 18 , includeFontPadding: false, fontWeight: '400'},
});
