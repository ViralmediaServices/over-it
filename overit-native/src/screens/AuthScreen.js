      ...
      >
        ...
        <View style={styles.heading}>
          <Text style={styles.h1}>
            {mode === 'signup' ? 'Begin your healing' : 'Welcome back'}
          </Text>
          <Text style={styles.sub}>
            {mode === 'signup'
              ? 'A private, judgment-free space to heal.'
        ...
        >
          ...
          >
            {loading
              ? <ActivityIndicator color={t.mutedLt}/>
...
const styles = StyleSheet.create({
  ...
  logoText: { fontSize: 28, fontWeight: '800', letterSpacing: -1, color: '#c4b5fd' },
  heading:  { alignItems: 'center', marginBottom: 26, width: '100%' },
  h1:       { fontSize: 22, fontWeight: '700', letterSpacing: -0.5, color: t.text, marginBottom: 7 },
  sub:      { fontSize: 13.5, color: t.mutedLt, lineHeight: 21, textAlign: 'center' },
  ...
  ghostBtnText: { color: t.textDim, fontSize: 14 },
  ...
  fieldLabel:   { fontSize: 11, color: t.mutedLt, letterSpacing: 0.6, textTransform: 'uppercase', fontWeight: '600', marginBottom: 6 },
  input:        { backgroundColor: 'rgba(30,26,53,0.6)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', borderRadius: 10, padding: 13, color: t.text, fontSize: 14 },
  inputFocused: { borderColor: 'rgba(124,58,237,0.55)' },
  error:      { color: '#f87171', fontSize: 12.5, marginBottom: 12, textAlign: 'center' },
  ...
  toggle:     { marginTop: 16 },
  toggleText: { color: t.mutedLt, fontSize: 13 },
  legal:      { fontSize: 11, color: t.muted, textAlign: 'center', marginTop: 22, lineHeight: 18 },
});
